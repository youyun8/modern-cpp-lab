...
int main() {
  ...
  return 0;
    ...
    callouts: [
      ...
      { n: 2, text: '折疊運算式 (args + ...) 於編譯期展開為 arg1 + arg2 + ... 的加總，取代遞迴樣板。' },
      { n: 3, text: 'template <> 完全特化為特定型別（此處 bool）提供專屬實作。' },
      { n: 4, text: 'if constexpr 於編譯期評估條件，未選中的分支不會被實體化，可取代許多 SFINAE 情境。' },
